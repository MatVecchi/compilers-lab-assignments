...
define i32 @foo(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %7 = shl i32 %1, 4
  %8 = sub i32 %7, %1
  %9 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %3)
  %10 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5)
  %11 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %6)
  %12 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %8)
  ret i32 0
}
