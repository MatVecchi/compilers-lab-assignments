          ...
          if (auto *BinOp = dyn_cast<BinaryOperator>(&Instr))
          {
            ...
            */
            ...
            else if (auto *CV = dyn_cast<ConstantInt>(operand_2))
            {
              ...
              continue; // Entrambi non costanti --> passo alla prossima istruzione

            // stampa di verifica: errs() << registerValue->getName() << "\n";
            // stampa di verifica: errs() << constantValue->getSExtValue() << "\n";
            ...
            // stampa di verifica: errs() << "Opt done" << "\n";
