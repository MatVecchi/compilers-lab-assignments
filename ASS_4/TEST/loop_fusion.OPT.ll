...
for.cond:                                         ; preds = %for.inc, %if.then
  ...
  %fused.iv = add i32 %i2.0, 1
  %cmp3 = icmp slt i32 %i2.0, 5
  br i1 %cmp3, label %for.body, label %for.end37
...
for.inc:                                          ; preds = %for.end34
  %inc = add nsw i32 %i2.0, 1
  br label %for.cond, !llvm.loop !6

for.body10:                                       ; preds = %for.body
  %sub = sub nsw i32 %fused.iv, 1
...
if.end38:                                         ; preds = %entry, %for.end37
