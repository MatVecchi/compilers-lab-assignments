...
for.cond16:                                       ; preds = %for.inc21, %for.end
  %n15.0 = phi i32 [ 0, %for.end ], [ %inc22, %for.inc21 ]
  %cmp17 = icmp slt i32 %n15.0, 10
...
for.cond25:                                       ; preds = %for.inc30, %for.end23
  %n24.0 = phi i32 [ 0, %for.end23 ], [ %inc31, %for.inc30 ]
  %cmp26 = icmp slt i32 %n24.0, 10
